...
FunctionsToExport = 'Get-TdpscAccount', 'Get-TdpscApiBaseAddress', 'Get-TdpscAuth', 
               'Get-TdpscPerson', 'Get-TdpscPersonSearch', 
               'Get-TdpscRestrictedPersonSearch', 'New-TdpscAccount', 
               'New-TdpscAuth', 'New-TdpscAuthCached', 'New-TdpscAuthLogin', 
               'New-TdpscAuthLoginAdmin', 'New-TdpscAuthLoginSso', 
               'New-TdpscPersonImport', 'Set-TdpscAccount', 
               'Set-TdpscApiBaseAddress', 'Set-TdpscPerson'
